	...
	<div class="container">
		...
		<div class="card-wrap">
			...
			<div class="card border-0 shadow card--welcome is-show" id="welcome">
					...
					<div class="board" id="board">
						...
						<div class="row etcBox">
							...
							<div class="col-6" align=left>
								...
								${Board_Context.id} ${Board_Context.nickname} <span>l</span>
				...
				<form	action="${pageContext.request.contextPath}/delete.comment?parent_board=${Board_Context.board_num}"	method="post">
							<c:forEach var="i" items="${comments}">
								<div class="row comment">
								  ...
								  <input type="text" name="comm_num"  value="${i.comm_num}"  style="visibility:hidden;">
								   <input type="text" name="parent_board"  value="${i.parent_board}"  style="visibility:hidden;">
							</c:forEach>
					</form>
