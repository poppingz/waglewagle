...
<body>
		...
		<form action="${pageContext.request.contextPath}/modify.board" method="post">
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="col-3">	
				글 번호  <input type="text"  class="form-control mb-2" name="board_num"  value="${Board_Context.board_num}">			
					
				</div>
				<div class="col-9">
				닉네임	 <input type=text class="form-control mb-2" name="nickname"	 value="${Board_Context.nickname}">
				</div>


				<div class="col-12">
				제목	<input type=text class="form-control mb-2" 	name="title"  value="${Board_Context.title}">
				</div>
